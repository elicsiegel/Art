...
import { getSlugName, convertToArray, numOfCoordinatesToGet } from '../../reducers/selectors';
...
const mapStateToProps = (state, ownProps) => ({
  ...
  numOfCoordinatesToGet: numOfCoordinatesToGet(state.artworks[ownProps.match.params.artistName]),
  coordinates: convertToArray(state.coordinates[ownProps.match.params.artistName])
});
